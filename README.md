...
You have to change few settings in `/Code-Institute---Final-Project/issue_tracker/settings.py` file:

`DEBUG = False` to `DEBUG = True`

and comment out these production settings at the end of the file:
